...
pub mod disk {
    ...
    pub use crate::disk::{
        ...
        CheckPartsResp, DecodedDeleteOptions, DeleteOptions, Disk, DiskAPI, DiskInfo, DiskInfoOptions, DiskLocation, DiskOption,
        DiskStore, FileInfoVersions, FileReader, FileWriter, HEALING_MARKER_PATH, OldCurrentSize, RUSTFS_META_BUCKET,
        ReadMultipleReq, ReadMultipleResp, ReadOptions, RenameDataResp, STORAGE_FORMAT_FILE, TRANSACTION_RPC_VERSION,
        UpdateMetadataOpts, VolumeInfo, WalkDirOptions, decode_delete_options_payload, decode_rename_data_payload, new_disk,
